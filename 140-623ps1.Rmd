...
- Calculate the sample size necessary for estimating mortality in children < 3 years of age with
a desired level of precision.
- Estimate the sample size for a new study of vitamin A and mortality in children < 3 years of
age.
...
|--|--|--|
|0.25|12|`r samp(s=12,d=0.25)`|
|0.25|20|`r samp(s=20,d=0.25)`|
|0.5|12|`r samp(s=12,d=0.5)`|
|0.5|20|`r samp(s=20,d=0.5)`|
|0.75|12|`r samp(s=12,d=0.75)`|
|0.75|20|`r samp(s=20,d=0.75)`|
...
|--|--|--|
|0.0294|1.20|`r samp2(p1=0.0294,p2=(0.0294/1.20))`|
|0.0244|1.00|Inf|
|0.0344|1.75|`r samp2(p1=0.0344,p2=(0.0344/1.75))`|
|0.0294|1.20|`r samp2(p1=0.0294,p2=(0.0294/1.20))`|
|0.0244|1.00|Inf|
|0.0344|1.75|`r samp2(p1=0.0344,p2=(0.0344/1.75))`|

As the relative risk approaches 1, the sample size gets larger. Using the method above, I obtained Inf (short for infinity) when the relative risk was 1.
...
Mortality Rate in the Control Group | Relative Risk of Interest | Sample Size per Group 
|--|--|--|
|0.0294|1.20|`r samp3(p1=0.0294,p2=(0.0294/1.20))`|
|0.0244|1.00|Inf|
|0.0344|1.75|`r samp3(p1=0.0344,p2=(0.0344/1.75))`|
|0.0294|1.20|`r samp3(p1=0.0294,p2=(0.0294/1.20))`|
|0.0244|1.00|Inf|
|0.0344|1.75|`r samp3(p1=0.0344,p2=(0.0344/1.75))`|
