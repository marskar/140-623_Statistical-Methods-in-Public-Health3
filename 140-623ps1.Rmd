...
|--|--|--|
|0.25|12|`r round(samp(s=12,d=0.25))`|
|0.25|20|`r round(samp(s=20,d=0.25))`|
|0.5|12|`r round(samp(s=12,d=0.5))`|
|0.5|20|`r round(samp(s=20,d=0.5))`|
|0.75|12|`r round(samp(s=12,d=0.75))`|
|0.75|20|`r round(samp(s=20,d=0.75))`|
...
|--|--|--|
|0.0294|1.20|`r round(samp2(p1=0.0294,p2=(0.0294/1.20)))`|
|0.0244|1.00|Inf|
|0.0344|1.75|`r round(samp2(p1=0.0344,p2=(0.0344/1.75)))`|
|0.0294|1.20|`r round(samp2(p1=0.0294,p2=(0.0294/1.20)))`|
|0.0244|1.00|Inf|
|0.0344|1.75|`r round(samp2(p1=0.0344,p2=(0.0344/1.75)))`|
...
Mortality Rate in the Control Group | Relative Risk of Interest | Sample Size per Group 
|--|--|--|
|0.0294|1.20|`r round(samp3(p1=0.0294,p2=(0.0294/1.20)))`|
|0.0244|1.00|Inf|
|0.0344|1.75|`r round(samp3(p1=0.0344,p2=(0.0344/1.75)))`|
|0.0294|1.20|`r round(samp3(p1=0.0294,p2=(0.0294/1.20)))`|
|0.0244|1.00|Inf|
|0.0344|1.75|`r round(samp3(p1=0.0344,p2=(0.0344/1.75)))`|
